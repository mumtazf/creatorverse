...
const EditCreator = () => {
    ...
    const updateCreator = async(event) => {
        ...
        await supabase.from('creators').update({name: creator.creator_name, description: creator.creator_description, url: creator.creator_url, imageUrl: creator.creator_image});
        window.location = "/";
    }
